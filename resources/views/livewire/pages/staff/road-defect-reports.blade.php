<x-staff.staff-navigation page_title="Road Defect Reports">
    ...
    <x-staff.road-defect-reports-page-content-base>
        ...
        <x-slot:dropdown_filters_container>
            ...
            <div x-data="{ activeFilter: 'all' }" class="flex flex-wrap md:flex-nowrap space-x-1 md:space-x-2">
        ...
        <x-slot:table_page_description>
            <p class="mt-0 lg:text-sm text-xs text-[#656565] pl-3 mr-auto">
        ...
        <x-slot:action_buttons_container>
            <button type="button"
                    ...
                    class="ml-auto mt-4 flex gap-x-[8px] w-auto text-xs px-[14px] py-[10px] font-normal tracking-wider text-[#FFFFFF] bg-gradient-to-b from-[#84D689] to-green-500 rounded-full hover:drop-shadow hover:bg-[#4AA76F] hover:scale-105 hover:ease-in-out hover:duration-300 transition-all duration-300 [transition-timing-function:cubic-bezier (0.175,0.885,0.32,1.275)] active:-translate-y-1 active:scale-x-90 active:scale-y-110">
                ...
                <table class="w-full text-left divide-y divide-gray-300">
                    ...
                    @forelse ($roadDefectReports as $report)
                        ...
                        <tr class="{{ $loop->iteration % 2 === 0 ? 'bg-white' : 'bg-gray-50' }} hover:bg-gray-100">
                            ...
                            <td class="px-4 py-3 text-xs font-medium italic">  {{ \App\Models\Severity::find($report->label)?->label ?? 'N/A' }}</td>
